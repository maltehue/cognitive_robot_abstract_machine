...
SymbolicTheory` with two boolean facts and a small regime/parameter decision vocabulary split across
two families. It proves the framework runs a theory it has never heard of and keeps any domain
(pouring) vocabulary out of the framework, mirroring the repository's established mimic-class pattern.
"""
...
"""Attribute name of the regime decision family."""

PARAMETER_FAMILY = "parameter_decisions"
"""Attribute name of the parameter decision family."""
...
class RaiseAlert(RegimeDecision):
    """Regime decision chained on :class:`OpenValve` within the regime family to escalate."""
...
def build_gauge_theory() -> GeneralRDRTheory[GaugeSituation]:
    ...
    conclusion. Together they exercise both write channels, a defeater, intra-family chaining and
    cross-family chaining.
    """

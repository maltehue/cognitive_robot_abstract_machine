    ...
    def from_world(cls, world: World) -> Self:
        ...
        with world.modify_world():
            ...
            neck = Neck(
                ...
                pitch_body=world.get_connection_by_name("head_2_joint"),
                yaw_body=world.get_connection_by_name("head_1_joint"),
                _world=world,
            )
            tiago.add_neck(neck)
            ...
            left_arm_park = JointState(
                ...
                joint_names=[
                    world.get_connection_by_name("arm_left_1_joint"),
                    world.get_connection_by_name("arm_left_2_joint"),
                    world.get_connection_by_name("arm_left_3_joint"),
                    world.get_connection_by_name("arm_left_4_joint"),
                    world.get_connection_by_name("arm_left_5_joint"),
                    world.get_connection_by_name("arm_left_6_joint"),
            ...
            right_arm_park = JointState(
                ...
                joint_names=[
                    world.get_connection_by_name("arm_right_1_joint"),
                    world.get_connection_by_name("arm_right_2_joint"),
                    world.get_connection_by_name("arm_right_3_joint"),
                    world.get_connection_by_name("arm_right_4_joint"),
                    world.get_connection_by_name("arm_right_5_joint"),
                    world.get_connection_by_name("arm_right_6_joint"),

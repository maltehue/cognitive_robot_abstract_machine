    ...
    def from_world(cls, world: World) -> Self:
        ...
        with world.modify_world():
            ...
            arm_park = JointState(
                ...
                joint_names=[
                    world.get_connection_by_name("joint_lift"),
                    world.get_connection_by_name("joint_arm_l3"),
                    world.get_connection_by_name("joint_arm_l2"),
                    world.get_connection_by_name("joint_arm_l1"),
                    world.get_connection_by_name("joint_arm_l0"),
                    world.get_connection_by_name("joint_wrist_yaw"),
                    world.get_connection_by_name("joint_wrist_pitch"),
                    world.get_connection_by_name("joint_wrist_roll"),
                ],
